...
public class MultiPurposeListTest {
	...
	public void testAdd() {
		...
		for (int i = 0; i < 100; i++)
			mpl.add(Integer.toString(i));
		
		assertEquals(100, mpl.size());
		
		for (int i = 0; i < 100; i++)
			assertEquals(Integer.toString(i), mpl.get(i));
	...
	public void testAddSorted()
	{
		...
		mpl.addSorted("teacherslys");
		mpl.addSorted("zaf");
		mpl.addSorted("lkars");
		
		assertEquals("lkars, teacherslys, zaf", mpl.toString());
	}
	...
	public void testRemove() {
		...
		assertEquals("foo, bar, foofoo, barbar, foobar", mpl.toString());
	...
	public void testIndexOf() {
		...
		assertEquals("One, Two, Three, Four", mpl.toString());
